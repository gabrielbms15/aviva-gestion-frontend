...
import { criteriosEif, GRUPO_LABELS_EIF } from "./data";

export default function EquiposInfraestructuraPage() {
    return (
        <>
            <Header />
            <main className="flex-grow py-20 lg:py-28 relative z-10">
                <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-2 text-xs text-deep-blue/40 font-semibold mb-10 uppercase tracking-wider">
                        ...
                        <span className="text-deep-blue/70">Gestión de Equipos e Infraestructura</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center mb-12 text-center">
                        ...
                        <p className="text-deep-blue/50 text-sm max-w-lg leading-relaxed">
                            Seguimiento y gestión de criterios del macroproceso EIF.
                            Expande cada criterio para gestionar requerimientos, documentos y estados.
                        </p>
                    </div>

                    <MacroprocesoManagementClient
                        criterios={criteriosEif}
                        grupoLabels={GRUPO_LABELS_EIF}
                        lsStateKey="eif_criteria_state"
                        lsLeaderKey="eif_leader_info"
                    />
