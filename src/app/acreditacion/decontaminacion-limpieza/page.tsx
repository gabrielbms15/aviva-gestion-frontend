...
import { criteriosDlde, GRUPO_LABELS_DLDE } from "./data";

export default function DecontaminacionLimpiezaPage() {
    return (
        <>
            <Header />
            <main className="flex-grow py-20 lg:py-28 relative z-10">
                <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-2 text-xs text-deep-blue/40 font-semibold mb-10 uppercase tracking-wider">
                        ...
                        <span className="text-deep-blue/70">Decontaminación, Limpieza, Desinfección y Esterilización</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center mb-12 text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-display font-extrabold text-deep-blue tracking-tight leading-tight mb-3">
                            Decontaminación, Limpieza,<br />Desinfección y Esterilización
                        </h1>
                        <p className="text-deep-blue/50 text-sm max-w-lg leading-relaxed">
                            Seguimiento y gestión de criterios del macroproceso DLDE.
                            Expande cada criterio para gestionar requerimientos, documentos y estados.
                        </p>
                    </div>

                    <MacroprocesoManagementClient
                        criterios={criteriosDlde}
                        grupoLabels={GRUPO_LABELS_DLDE}
                        lsStateKey="dlde_criteria_state"
                        lsLeaderKey="dlde_leader_info"
                    />
